...
const buttonVariants = cva(
    "text-[15px] rounded-[10px] cursor-pointer font-medium transition-colors",
    {
        variants:{
            variant:{
                default: "w-full p-[10px] mt-[10px] bg-[#536F8F] text-[#f5f5f5] hover:bg-[#4E6987]",
                ...
                filter:"bg-[#2D5A8E] w-10 h-10 flex items-center rounded-[10px] flex items-center hover:bg-[#2F4B6A]"
            },
            defaultVariants:{
                variant: "default",
