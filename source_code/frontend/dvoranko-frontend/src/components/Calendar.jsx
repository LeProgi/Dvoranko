...
const Calendar = ({handleDateClick, daysOpen}) => {

    const dani = daysOpen.split(";").filter(x => x !== "");
    const radniDani = dani.map(dan => dan.substring(0, 3));
    ...
    return (
        <FullCalendar
            ...
            dateClick={(info) => {
                ...
                if (!radniDani.includes(day)) return;
